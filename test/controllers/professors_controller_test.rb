...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { department: @professor.department, name: @professor.name, office_id: @professor.office_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { department: @professor.department, name: @professor.name, office_id: @professor.office_id } }
