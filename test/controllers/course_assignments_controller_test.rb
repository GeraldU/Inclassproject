...
class CourseAssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_assignment" do
    assert_difference('CourseAssignment.count') do
      post course_assignments_url, params: { course_assignment: { course_id: @course_assignment.course_id, name: @course_assignment.name, professor_id: @course_assignment.professor_id } }
    end
  ...
  test "should update course_assignment" do
    patch course_assignment_url(@course_assignment), params: { course_assignment: { course_id: @course_assignment.course_id, name: @course_assignment.name, professor_id: @course_assignment.professor_id } }
