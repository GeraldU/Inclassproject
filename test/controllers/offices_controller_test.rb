...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { building: @office.building, room: @office.room } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { building: @office.building, room: @office.room } }
